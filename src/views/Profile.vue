<template>
  <div class="admin-section profile">
    <div class="container h-100">
      <div class="intro">
        <div class="row">
          <div class="col-md-6 ml-3 text-left intro-text-content">
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade pt-3" id="account" role="tabpanel" aria-labelledby="account-tab">
            <div class="container">
              <div class="row">
                <div class="col-md-">
                  <div class="alert alert-info">Please use the Reset password email button for reseting the password. The form doens't work currently</div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
